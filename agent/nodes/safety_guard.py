...
_HIGH_RISK_KEYWORDS: frozenset[str] = frozenset({
    # 自伤 / 自杀
    "自杀", "自残", "不想活", "结束生命", "轻生", "去死", "想死",
    "割腕", "跳楼", "服药自尽", "了结自己", "活不下去",
    # 伤害他人
    "伤害他人", "杀人", "伤人", "杀死", "杀掉", "暴力",
    "报仇", "害人", "下毒", "投毒",
    # 英文高风险
...
_MEDIUM_RISK_KEYWORDS: frozenset[str] = frozenset({
    # 金融投资
    "投资", "炒股", "股票", "基金", "理财", "期货", "加密货币",
    "比特币", "买房", "贷款", "债务", "破产",
    # 医疗健康
    "手术", "医疗", "诊断", "用药", "治疗", "化疗", "癌症",
    "病情", "病危", "急救", "药量", "剂量",
    # 法律纠纷
    "离婚", "官司", "诉讼", "律师", "判决", "仲裁", "起诉",
    "坐牢", "刑事", "犯罪",
    # 英文中风险
    "invest", "surgery", "diagnosis", "medication", "lawsuit", "divorce",
})
